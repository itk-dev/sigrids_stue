...
function sigrids_stue_theme_get_default_settings($theme) {
...
function sigrids_stue_settings($saved_settings, $subtheme_defaults = array()) {

  // Get the default values from the .info file.
  $defaults = sigrids_stue_theme_get_default_settings('spanien');
  ...
  // Breadcrumb
  $form['navigation']['sigrids_stue_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#size'          => 3,
    '#title'         => t('Breadcrumb separator'),
    '#default_value' => $settings['sigrids_stue_breadcrumb_separator'],
  ...
  $form['stylesheets']['sigrids_stue_stylesheet_conditional'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use IE specific stylesheet conditions in the .info file'),
    '#default_value' => $settings['sigrids_stue_stylesheet_conditional'],
  ...
  $form['typography']['sigrids_stue_typography_links_icons'] = array(
    '#type'          => 'radios',
    ...
    '#default_value' => isset($settings['sigrids_stue_typography_links_icons']) ? $settings['sigrids_stue_typography_links_icons'] : 'no',
  ...
  $form['misc']['sigrids_stue_aakb_topbar'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Display Aarhus Kommune topbar'),
    '#default_value' => $settings['sigrids_stue_aakb_topbar'],
  ...
  $form['development']['sigrids_stue_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => $settings['sigrids_stue_rebuild_registry'],
